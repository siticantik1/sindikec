...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Tambah Barang Inventaris Baru (Kec. Tawang)</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            {{-- ====================================================== --}}
            {{-- PERBAIKAN UTAMA: Action form diarahkan ke 'tawang.inventaris.store' --}}
            {{-- ====================================================== --}}
            <form action="{{ route('tawang.inventaris.store') }}" method="POST">
                @csrf
                <div class="row">
                    <!-- Kolom Kiri -->
                    <div class="col-md-6">
                ...
                <div class="d-flex justify-content-end">
                    {{-- PERBAIKAN: Tombol kembali diarahkan ke 'tawang.inventaris.index' --}}
                    <a href="{{ route('tawang.inventaris.index') }}" class="btn btn-secondary mr-2">Batal</a>
